...
?>
<b><?=ucwords(str_replace("_"," ","brand"))?></b>
  <table cellspacing="3" cellpadding="3" border="0"  width="100%" class="bdr">
				...
				<table width="60%" border="0"  cellpadding="0" cellspacing="0" class="bodytext">
				  <TR>
					...
					<td nowrap="nowrap" align="right">
					  <input type="hidden" name="cmd" id="cmd" value="search_brand" >
   ...
   <tr>
   <td> 
		<a href="brand.php?cmd=edit" class="nav3">Add a brand</a>
		<table cellspacing="1" cellpadding="3" border="0" width="100%" class="bodytext">
		 ...
		 ?>
			<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
			  ...
			  <td nowrap >
				  <a href="brand.php?cmd=edit&id=<?=$arr[$i]['id']?>" class="nav">Edit</a> |
				  <a href="brand.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="nav" onClick=" return confirm('Are you sure to delete this item ?');">Delete</a> 
			 </td>
