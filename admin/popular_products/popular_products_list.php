...
?>
<b><?=ucwords(str_replace("_"," ","popular_products"))?></b>
  <table cellspacing="3" cellpadding="3" border="0"  width="100%" class="bdr">
   ...
   <tr>
   <td> 
		<a href="popular_products.php?cmd=edit" class="nav3">Add a popular_products</a>
		<table cellspacing="1" cellpadding="3" border="0" width="100%" class="bodytext">
		 ...
		 ?>
			<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
			  ...
			  <td nowrap >
				  <a href="popular_products.php?cmd=edit&id=<?=$arr[$i]['id']?>" class="nav">Edit</a> |
				  <a href="popular_products.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="nav" onClick=" return confirm('Are you sure to delete this item ?');">Delete</a> 
			 </td>
		   ...
		   <td colspan="10" align="center">
			  <?php              
					  ...
					  $res  = $db->select($info);  
						...
						$self = 'popular_products.php?cmd=list';
						$nav  = '';
